        ...
        return(
            <View style = {styles.container}>
                ...
                <View style = {styles.header}>
                    <TouchableHighlight underlayColor = 'transparent' onPress = {this.navigateToScreen('Events')} style = {styles.backIconImage} >
                        <Image
                            style={{width: 20, height: 20, marginRight:15}}
                            source={require('../../images/leftarrowWhite.png')}
                        />
                    </TouchableHighlight>
                    <Text style = {{color: '#fff', fontSize: 20}}>Hackathon</Text>
                </View>
                {/* Header Component End */} 

                <View style = {styles.body}>
                    <View style = {styles.imageCard}>
                        <Image source = {require('../../images/events/hackathon.png')} style = {styles.image}/>
                        <Text style = {{textAlign:'center'}}>Hackathon</Text>
                    </View>
                    <WebView
                    source={{
                        html:
